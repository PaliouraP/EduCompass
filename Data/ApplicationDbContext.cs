    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedDataToQuestionsAndAnswers(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Question>().HasData(
                ...
                new Question { Id = 38, Content = "Μέσω της παρακολούθησης του μαθήματος Ευφυείς Πράκτορες ο φοιτητής μαθαίνει να εφαρμόζει το μοντέλο “αντιλαμβάνομαι-αποφασίζω-________”", CourseId = 3 },
                ...
                new Question { Id = 40, Content = "Mε ποιο είδος πρακτόρων θα ασχοληθούν οι φοιτητές στα πλαίσια του μαθληματος Ευφυείς Πράκτορες;", CourseId = 3 }
            );
